...
panel_direction1 = 0
panel_direction2 = 0
save_loc =  './Plots/' + str(panel_angle1) + '_az' + str(panel_direction1) + '_to_' + str(panel_angle2) + '_az' + str(panel_direction2) + '_ratio.png' #insert filepath to output folder and desired name
...
print(allwavelengths)
hm = sns.heatmap(allwavelengths, cmap='viridis', xticklabels = 6, yticklabels = 3, cbar_kws={'label': 'Energy per Sol Ratio'})
hm = hm.invert_yaxis()
